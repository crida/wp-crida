 ...
 * @return void
 */
function la_crida_add_capabilities( $posttype ) {
...
add_filter( 'nav_menu_css_class', 'la_crida_portfolio_menu_item_classes', 10, 2 );
/**
 ...
 */
function la_crida_portfolio_menu_item_classes( $classes, $item )
{
