...
class Featured_Content {
	...
	public static function register_setting() {
		add_settings_field( 'featured-content', __( 'Featured content', 'la_crida' ), array( __CLASS__, 'render_form' ), 'reading' );
	...
	public static function render_form() {
		...
		<div id="featured-content-ui">
			<p>
				<label for="featured-content-tag-name"><?php echo _e( 'Tag name:', 'la_crida' ); ?></label>
			...
			<p>
				<label for="featured-content-quantity"><?php _e( 'Number of posts:', 'la_crida' ); ?></label>
			...
			<p>
				...
				<label for="featured-content-hide-tag"><?php _e( 'Hide tag from displaying in post meta and tag clouds.', 'la_crida' ); ?></label>
			</p>
		</div>
		<?php
	}
